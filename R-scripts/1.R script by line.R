...
#------------------------------#
#   1. Open R in the cluster   #
#------------------------------#

cd Cluster_and_R_course

qrsh -pe smp 8 -l h_vmem=5G
module avail
module load R/3.4.0
R
...
write.csv(table, file = paste0(folder.output, "/Table1.Some_descriptive_variables.csv"), row.names = F)
